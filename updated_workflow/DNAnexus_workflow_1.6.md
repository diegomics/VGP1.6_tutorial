...
[Diego]: For consistency, I would divide the text in A. Assembly: 1. Falcon and Unzip. 2. Purge Dups. B. Scaffolding: 1. 10X. 2. Bionano hybrid. 3. Salsa HiC. C. Polishing: 1. Arrow. 2. Longranger Freebayes. But in order to achieve that consistency, the name of the workflows should be updated to, for instance, Assembly_2_purge_dups, Scaffolding_3_Salsa_HiC, Polishing_1_Arrow, and so on. What do you think?
